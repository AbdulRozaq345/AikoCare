    ...
    <div className="relative py-3 sm:max-w-xl sm:mx-auto">
      <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-5">
            <label className="font-semibold text-sm text-gray-800 pb-1 block" htmlFor="login">E-mail</label>
            <input className="border border-gray-500 rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" type="text" id="login" />
            <label className="font-semibold text-sm text-gray-800 pb-1 block" htmlFor="password">Password</label>
            <input className="border border-gray-500 rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" type="password" id="password" />
          </div>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <a className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline" href="#">or sign up</a>
